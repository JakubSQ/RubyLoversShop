...
RSpec.describe LineItemRemover, type: :model do
  ...
  context 'shopping cart includes two products' do
    it 'one product having 10 instances remove from cart' do
      subject = LineItemRemover::DeleteLineItem.new.call(cart, line_item)
    ...
    it 'two products having 10 instances remove from cart' do
      LineItemRemover::DeleteLineItem.new.call(cart, line_item)
      subject = LineItemRemover::DeleteLineItem.new.call(cart, line_item1)
